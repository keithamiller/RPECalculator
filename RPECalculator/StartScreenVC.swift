...
class StartScreenVC: UIViewController {
    ...
    @IBOutlet weak var previousSet: UIButton!
    ...
    func checkForIpadAir(){
        print(UIDevice.current.modelName)
        if UIDevice.current.modelName == "iPad Air" || UIDevice.current.modelName == "iPad Air 2" {
            previousSet.isHidden = true
        }
        else {
            print("Not Ipad Air")
        }
